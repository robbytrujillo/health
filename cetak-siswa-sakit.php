...
<div class="container mt-3 mb-3">
    <h4 class="mt-3 mb-3 text-center">Data Siswa Sakit</h4>
    <a href="siswa-user.php" class="btn btn-outline-success rounded-pill">🔙 <b>Kembali</b></a>
    <br><br>
